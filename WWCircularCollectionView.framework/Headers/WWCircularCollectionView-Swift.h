...
SWIFT_MODULE_NAMESPACE_PUSH("WWCircularCollectionView")
@class NSCoder;
@class UICollectionViewLayout;

SWIFT_CLASS("_TtC24WWCircularCollectionView24WWCircularCollectionView")
@interface WWCircularCollectionView : UICollectionView
...
@interface WWCircularCollectionView (SWIFT_EXTENSION(WWCircularCollectionView)) <UICollectionViewDataSource>
...
@interface WWCircularCollectionView (SWIFT_EXTENSION(WWCircularCollectionView)) <UICollectionViewDelegate>
...
SWIFT_CLASS("_TtC24WWCircularCollectionView30WWCircularCollectionViewLayout")
@interface WWCircularCollectionViewLayout : UICollectionViewLayout
- (void)prepareLayout;
...
@interface WWCircularCollectionViewLayout (SWIFT_EXTENSION(WWCircularCollectionView))
